...
from unet_multiclass import UNetClassifier
...
def main(args):
    ...
    # Load full dataset
    dataset = MicrogliaDataset(images_dir='./image_subset', 
                               #labels_dir='./labels',
                               labels_dir='./labels_classification_test', 
    ...
    visualize_predictions(model, val_loader, device, args.multiclass, num_images=100, show=False, save="results_validation")

if __name__ == "__main__":
    parser = argparse.ArgumentParser()
    parser.add_argument("--seed", type=int, default=4, help="Seed set before splitting dataset into validation & training")
    parser.add_argument("--multiclass", type=bool, default=True, help="When true it is multiclass segmentation, when false it's binary")
    parser.add_argument("--augmentation", type=bool, default=True, help="Whether or not augmentation is applied to dataset")
    parser.add_argument("--clahe", type=bool, default=True, help="Whether CLAHE is applied")
    parser.add_argument("--epochs", type=int, default=100, help="Number of epochs")
    parser.add_argument("--lr", type=float, default=0.001, help="Learning rate")
    parser.add_argument("--image_size", type=int, default=512, help="Image crop size")
